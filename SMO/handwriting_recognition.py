...
''''  #########################################   Digit Recognition with SVM ##########################################
	 We can do the same work with K-nearest neighbours , but in that case we have to carry over all examples 
	but using SVM we can carry far less examples and achieve comparable performance 

	1. Text file provided
	2. Create vectors from the binary images
...
def loadImages(dirName):
	hwLabels = list()
	trainingFileList = listdir(dirname) # list all the files in that dirname folder
